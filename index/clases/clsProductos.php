...
?>
    ...
    public function extraer_mis_productos($id_registrado)
    {
        ...
        ?>
            <div style="background-color: #EEEEEE; border-style: groove; align-items: center;" class="col-lg-4 col-md-4 col-sm-4 gallery">
                <a href=<?php echo $link; ?>><img style="width: 600px; height: 250px;position: relative;" class="img-responsive" id="imgSalida" width="50%" height="50%" src="<?php echo $url_img; ?>" /></a>
                <div class="form-group">
                    <label>
                        <p>PRODUCT NAME:</p> <?php echo $nombre; ?>
                    </label>
    ...
    public function extraer_productos_edit($id_producto)
    {
        ...
        ?>
            ...
            <div class="form-group">
                <label for="name">Product Name*</label> <input type="name" name="name" class="form-control" placeholder="Name of Product" value="<?php echo $nombre; ?>">

            </div>
            <div class="form-group">
                <label for="descripcion_breve">Brief description of the product</label> <input type="text" name="descripcion_breve" class="form-control" placeholder="brief description of the product" value="<?php echo $descrip_b; ?>">
            ...
            <div class="form-group">
                ...
                <br />
                <img style="width: 300px; height: 300px" class="form-control" id="imgSalida" width="50%" height="50%" src=<?php echo $url_img; ?> />
    ...
    public function ver_producto($id_producto)
    {
        ...
        ?>
            ...
            <div class="form-group">
                ...
                <br>
                <label namespace="name"><?php echo $nombre; ?></label>
            </div>
            <div class="form-group">
                <label for="descripcion_breve">Brief description of the product: </label>
                <br>
                <label namespace="descripcion_breve"><?php echo $descrip_b; ?></label>

            </div>
            <div class="form-group">
                <label for="descripcion">Product description: </label>
                <br>
                <label namespace="descripcion"><?php echo $descripcion; ?></label>

            </div>
            <div class="form-group">
                <label for="descripcion">Description of the product: </label>
                <br>
                <label namespace="descripcion"><?php echo $descripcion; ?></label>
            ...
            <div class="form-group">
                ...
                <br>
                <label namespace="type"><?php echo $ob->extraer_nombre_tipo($id_tipo); ?></label>
            </div>
            <div class="form-group">
